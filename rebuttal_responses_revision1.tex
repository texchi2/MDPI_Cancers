...
After discovery by our workflow, we performed the literature review by Embase/Pubmed  to find the evidence of suggested biomarker in cancer research.
...
%%%%%% bad guy
DKK1: 13 results of HNSCC
The Dickkopf1 (DKK1) gene encodes a protein that was mainly involved in Wnt and other signaling pathways. Overexpression of DKK1 indicated adverse OS in bladder urothelial carcinoma (BLCA), HNSCC, and PADD.\cite{Wei2020}
\cite{Shi2014}\cite{Gao2018}\cite{Chakraborty2020}\cite{Hu2020}\cite{Wei2020}
