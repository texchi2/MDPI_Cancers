...
We re-wrote the Introduction in detail according to the suggestion by reviewer \#2 (comment No 4).
%}
...
We re-wrote the Discussion with additional information according to the suggestion by reviewer \#3.
%}
%{% Answer_3-1_USP10.pdf, Answer_2-1.pdf
According to the reviewers' comments, we added new supplementary Figure S1, S2 %, S2, S3, and Table S2. We also replaced Figure 3D and 4A with high magnitude images from the same slides. We transferred the original Figure 2 into supplementary Figure S1 
...
In summary, the advantages of applying the TCGA data for cancer research include:
\begin{outline}
...
We appreciate the reviewer for the critical comment. We provide more evidence mentioned below to support the prognostic impact of these candidate genes. It needs to be further validated.
...
%17 out of 20 candidates
%?DKK1 (0.253635),
The 12 out of 20 positive and negative prognostic genes underlined are confirmed by comparable studies using SurvExpress with the TCGA cohort. Please see Figure \ref{fig:fig_SurvExpress}.
...
(Please see Figure \ref{fig:fig_HPA_USP10})
...
n conclusion, 20 candidate biomarkers, DKK1, CAMK2N1, STC2, PGK1, SURF4, USP10, NDFIP1, FOXA2, STIP1, DKC1, as well as ZNF557, ZNF266, IL19, MYO1H, FCGBP, LOC148709, EVPLL, PNMA5, IQCN (former name as KIAA1683), and NPB, are associated with the prognosis of OS in our study.
