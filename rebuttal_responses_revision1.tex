...
We analysed GSE2837 dataset (NCBI GEO database\cite{Chung2006}, HNSCC cohort 40 cases) from online tools: PrognoScan (availalbe at http://dna00.bio.kyutech.ac.jp/PrognoScan-cgi/PrognoScan.cgi)\cite{Mizuno2009a}.
MD Anderson (40 cases)
%https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE2837 \cite{Chung2006}
The GSE2837 has data from HNSCC cohort,
% VUMC, VAMC, UTMDACC (1992-2005)
which recruited 28 participants with 
relapse free survival (RFS) data, 
%(TCGA dataset: overall survival)
and microarray gene expression (Affymetrix X3P chips U133\_X3P).
The result shows the survival significance is in the following probes of genes:
%17 out of 20 candidates
11 genes achieve similar positive and negative prognostic effect comparable with our proposed candidate genes, however, PrognoScan has group separation cut by a skewed manner.
poor prognosis: DKK1, CAMK2N1, PGK1, SURF4, USP10, NDFIP1, FOXA2
better prognosis: IL19, FCGBP, KIAA1683 (IQCN), NPB
...
\caption{GSE2837 query results from PrognoScan}
