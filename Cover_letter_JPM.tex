...
%\end{MyColorPar}
% from page (ok)
The summary of holistic cancer care in this revised manuscript could be on the paragraphs marked in \textcolor{red}{Red} on page 13 (line 377 to line 392). Also, it is shown here in the following paragraph.
...
In the study of GSE65858 cohort, CAMK2N1, CALML5, and FCGBP, keep ahead of the curve by their FDR-corrected \textit{P} value ($< 0.05$), and Cox'HR ($>1.8$ or $<0.65$) (please see Table \ref{tab:table_top3_GSE65858} listed below,
...
%\subsection{The Purpose of a Sliding-window Cutoff Method}
Statistical significance (\textit{P} value) is affected by both sample size, error, effect size (substantive significance)\cite{Sullivan2012}\cite{Thiese2016}, and cutoff. 
...
scientific-notation=true]{0.0001074233} (please see supplementary figure S1, a "S"- or "W"-shaped \textit{P} value plot). % it is \ref{fig:pvaluePlot_NDFIP1
