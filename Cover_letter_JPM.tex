...
will be kick-out prematurely in "median cutoff" of survival analysis.
...
\begin{figure}
    ...
    \caption{Under cutoff-finding procedure of Kaplan-Meier analysis, the \textit{P}-value plot of gene "NDFIP1" shows: 1) 70\% of \textit{P} value is $<0.05$; 2) the middle part (zoom-in and revealed in inset box) has a "W" curve; 3) sliding-window cutoff selection could find it's optimized \textit{P} values while a median cut might yield \textit{P} value $<0.05$ or $>0.05$ by chance.}
...
\resizebox{\linewidth}{!}{%
\begin{tabular}{llll}
Gene Symbol & KM \textit{P} value & FDR-adjusted \textit{P} value & Cox’s univariate HR \\
\hline
CAMK2N1 & \num{6.87e-3} & 0.038 & 1.814 \\
FCGBP   & 0.01 & 0.039 & 0.573 \\
IL19    & 0.03 & 0.047 & 0.63  \\
IL19    & \num{2.69e-3} & 0.031 & 0.63\\
\hline
(values shown in dataset: GSE65858)\\
(IL19 has two probes in RNA-Seq experiment)\\
\hline
\end{tabular}%
}
\end{table}
