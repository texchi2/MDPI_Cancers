...
see https://www.biostars.org/p/153013/
...
First, although \acrshort{tcga} genomics data was harmonized, there are 
several points should be manually investigated and cleaned.

\begin{outline}
\1 including null expressed genes, over 50\% of the cohort, 
\1 After extended organizing, we found that the number of protein-coding genes in the TCGA RNA-Seq dataset should be corrected  (20499 -> 20500).
{
[main_marginSFP_HNSCC.R] line 1361
=> osccT_2021 <- osccT[c(30,31)] # [30] "days_to_last_followup", [31] "days_to_last_known_alive" 
OS_live_days /30 # derived from last followup [30]/ last known alive [31])
event (alive) => censored (status 0) # to handle missing data of censored by OS_months imputation
R help from Jorge I Velez
[line 1654]
=> gene correction (20499 -> 20500) from SLC35E2A to 2 genes:
# SLC35E2A: 9906
# SLC35E2B: 728661
}
\end{outline}
