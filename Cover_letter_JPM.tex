...
After detailed 梳理, we found that the number of protein-coding genes in the TCGA RNA-Seq dataset should be corrected  (20499 -> 20500)
The three challenges are not “challenges” at all. The authors exaggerated the difficulties here. 不要誇大說明 謙虛道歉，修改說法

The paragraphs marked in \textcolor{red}{Red} from page 2 (line 77) to page 3 (line 129) are the part of the manuscript that has been revised. Also, it was shown here in the following paragraph.
%%%
=>  However, there are three steps of biomarker discovery from survival analysis.
***=> Third, we need to find an optimal cutpoint of that \acrshort{rna} expression data to maximize candidate mining coverage. 這個 要改為 reviewer's comment (risk of maximizing P-value with cutoff scan)
...
