...
In those \textit{P}-value plots, we could see that the sliding-window selection of cutoff finding might collect more candidates (\textit{P} values far less than $0.001$) for further Cox's modeling.
...
\begin{tabularx}{\textwidth}{|l|p{6.0cm}|l|l|l|l|l|l|} % *** capital X or p{2cm}
% p{2cm}
\cline{1-8}
