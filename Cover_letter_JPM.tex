...
***The RLassoCox\cite{Liu2021} (bioconductor package, available at https://github.com/weiliu123/RLassoCox) trains the RLasso-Cox model based on gene expression profiles, survival information and gene interaction networks.
...
%x Bayesian Hyper-LASSO Classification for Feature Selection with Application to HNSCC RNA-seq Data\cite{Jiang2020} -> citing \cite{Li2018d}
RLassoCox\\
...
cv.mod.candidate 62 genes are not performed well either in GSE65858 HNSCC or TCGA HNSCC (please see Figure \ref{fig:Bayes62}).\\
...
%coxlogit: https://www.info.ucl.ac.be/~pdupont/pdupont/pdf/MCDM_14.pdf
...
Finally, we use gene signature, HK1, EZR, RRAGA, and DUSP16 to predict their survival impact on TCGA HNSCC cohort (please see Figure \ref{fig:signature4}).
