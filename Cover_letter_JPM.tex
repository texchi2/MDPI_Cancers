...
\1 After investigation of mRNA expression dataset obtained through Firehose API, we found that gene ID (9906), gene ID (728661), and their expression values were saved together under the entity of gene symbol "SLC35E2".
The expression file of SLC35E2 has almost double size than those of SLC35E1 or SLC35E3.
% [line 1549]
...
SLC35E2 is the previous symbol of SLC35E2A (Ref: https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:20863).
Thus, we made reassignment of the expression value as SLC35E2A and SLC35E2B, and updated the number of protein-coding genes in the TCGA HNSCC as 20500.
