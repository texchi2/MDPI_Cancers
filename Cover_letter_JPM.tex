...
Since we reviewed the results of sliding-window cutoff finding (from 50\% to 70\% quantile), the 20 preliminary candidates have FDR-corrected \textit{P} values from 1e-4 to 0.04 (or 0.001) (*** see a table?).
The top 3 the 3 biomarker candidates, CAMK2N1, CALML5, and FCGBP, have FDR-corrected \textit{P} values from \num{1.63e-5} to \num{1.97e-4} (please see Figure \ref{fig:figure4}, 
