...
We appreciate the reviewer for the agreement about mindfulness meditation and holistic cancer care. We briefed this section (and Figure 6), then will submit rest of it in the other manuscript.
...
The results shows that the model-selected features (62 genes) distribute within the region of small effect size (HR) on our previous volcano plots (please see Figure \ref{fig:Bayes62}; comparing with Figure \ref{fig:hazards3} and Figure \ref{fig:hazards534}), if see them individually.
