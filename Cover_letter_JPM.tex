...
%    \centering
  ...
  \end{subfigure}
    \caption{OS in TCGA for a gene signature including HK1, EZR, RRAGA, and DUSP16. Those genes have not significant survival impact if calculated individually.}
