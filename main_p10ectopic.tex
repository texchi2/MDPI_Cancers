...
% try omit last sentence
%Overexpression of DKK1 indicates adverse OS in bladder urothelial carcinoma (BLCA)\cite{Wei2020}, HNSCC\cite{Chakraborty2020}\cite{Hu2020}\cite{Wei2020}, and pancreatic adenocarcinoma (PAAD)\cite{Wei2020}.
...
One "HNSCC.clinical.Fire.Rda" tables and 20,500 "HNSCC.mRNA.Exp.[GeneName].\\Fire.Rda" tables were transposed and merged by their \_participant\_barcode (unique patient \acrlong{id}, \acrshort{id}) to yield a data frame with 528 rows (participants) against 20,581 columns (81 clinical features as well as 20,500 protein-coding \acrshort{rnaseq} of cancer specimen).
...
The tables were generated by latex code with the help from https://github.com/JDMCreator/LaTeXTableEditor.
...
We also give our mercy to mice belonging to the Mouse Tumor Biology Database (http://tumor.informatics.jax.org/mtbwi/index.do. Accessed 20 May 2020)
}
