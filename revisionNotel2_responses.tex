...
A good practice of research reproducibility is necessary in order to allow %previously developed methodology to be effectively applied on new data, or to allow 
...
Once those candidates are identified by Alex's laboratory (or community) as the targets, the compound screening could facilitate development of more individualized therapy for HNSCC patients and improve prognosis. %help to discover a potential drug for HNSCC therapy.
