...
%%%
Usually, how researchers used TCGA to find expression biomarkers
%%%%%%
\end{MyColorPar}
...
\end{MyColorPar} %%%
Usually, the investigators should get the rationale or revelation of the genes of interest on a specific cancer type. They should upload those genes manually onto bioinformatics tools, such as SurvExpress (http://bioinformatica.mty.itesm.mx:8080/Biomatec/ \newline
