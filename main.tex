...
The candidate genes were validated by using the Gene Expression Profiling Interactive Analysis tool (GEPIA1/2 database using TCGA datasets, developed by Zefang Tang and his colleagues\cite{Tang2017a}\cite{Tang2019}
...
Finally, these biomarkers were verified by using the gene expression profile from the GEO, HNSCC cell lines and tissues.\\
\end{MyColorPar} % red
...
\1 $h(t)$ is the hazard function determined by a set of n covariates ($X_1...X_n$, e.g., clinicopathological features, including age, gender, gene expression, cancer stage, smoking, alcohol, spiritual, emotional, and social status;
