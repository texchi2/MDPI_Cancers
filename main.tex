...
We wish the TCGA does collect holistic features from their participants in the future. 

holistic-enabled Electric healthcare record, EHR
Deep Patient
Under HL7, RESTful
deep learning by EHR-converted FHIR: with holistic observations
...
tobacco exposure, family support, cognitive status
pregnancy status
death assertion
HIV, HBV, HCV status
}
...
In personal history section of admission note (EHR for inpatient): 
< Habits >
　　　　-Tobacco:
　、　1.5　pack/day for　30　years
　　　　-Alcohol drinking:　Occasionally
　　　　-Betel nuts:　、　nuts/day for　30　years　
...
　　　　Stable
　　　　Suspected to be ” abuse ” or ”neglected victim” (if the answer is “Yes“ should be assisted by social workers)　No
...
In summary, those 10 candidate biomarkers, clinical T stage, and surgical margin are independent prognosis factors in our \acrshort{hnscc} study.
Thus, the prognosis model with coefficients is established from \acrshort{tcga} \acrshort{hnscc} cohort. The important input $X_1...X_n$ should be patients' features: age, specific 10 gene expressions, clinical T stage, and surgical margin.
%依舊是以管窺天
...
Moreover, we suggest TCGA should cover more holistic features:
...
The standardized, psychosocial (subjective) measures includes depression, stress, quality of life, anxiety, fatigue, mindfulness, mood and specific spiritual growth (ie, meaning of life)\cite{Hsiao2012}.
 psychological benefits (reduction of stress, fatigue, sleep disturbance, and depressive symptoms), and also optimizes immune functions (higher natural killer cell activity, higher \acrshort{ifng}, lower TNF-alpha, lower IL-6) 
...
Ching, T. et al. Opportunities and obstacles for deep learning in biology and medicine. J. R. Soc. Interface 15, (2018).\cite{Ching2018}
%慈悲心 利他心
