...
Suggested health care record - Besides physical, pathological, or psychological data, electric healthcare records (EHR) and \acrshort{tcga} should collect "holistic features".}
\label{fig:figure5}
\end{figure}
