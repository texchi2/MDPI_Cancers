...
\multicolumn{1}{|c|}{} &
  ...
  \multicolumn{2}{c|}{Multivariate} \\ \cline{4-9} 
...
{\color[HTML]{333333} IL19} &
  \multicolumn{2}{l|}{\cellcolor[HTML]{FFFFFF}{\color[HTML]{333333} interleukin 19}} &
  {\color[HTML]{333333} \num{3.7e-7}} &
  {\color[HTML]{333333} 0.002} &
  {\color[HTML]{333333} 0.472} &
  {\color[HTML]{333333} 0.351-0.635} &
  {\color[HTML]{333333} 0.459} &
  {\color[HTML]{333333} 0.340-0.619} \\ \hline
\rowcolor[HTML]{FFFFFF} 
{\color[HTML]{333333} FCGBP} &
  \multicolumn{2}{l|}{\cellcolor[HTML]{FFFFFF}{\color[HTML]{333333} \begin{tabular}[c]{@{}l@{}}Fc fragment of\\  IgG binding protein\end{tabular}}} &
  {\color[HTML]{333333} \num{1.2e-6}} &
  {\color[HTML]{333333} 0.008} &
  {\color[HTML]{333333} 0.484} &
  {\color[HTML]{333333} 0.359-0.653} &
  {\color[HTML]{333333} 0.496} &
  {\color[HTML]{333333} 0.366-0.674} \\ \hline
\multicolumn{9}{|l|}{} \\
\multicolumn{9}{|l|}{\multirow{-2}{*}{\begin{tabular}[c]{@{}l@{}}Selection criteria:
1) Kaplan-Meier Bonferroni-adjusted \textit{P} \textless 0.05;
2) Cox’s univariate and multivariate HR \textgreater{}= 1.8 or \textless{}= 0.5\end{tabular}}} \\ 
%\hline
\hline
\end{tabular}%
}
