...
\end{MyColorPar} % the rest moved into materials and methods
...
Finally, these 3 candidates have also been confirmed by a HNSCC study using the GSE2837 dataset other than the TCGA cohort. Please see Kaplan-Meier plots in Supplementary Figure S2.%\ref{fig:fig_GSE2837}.
