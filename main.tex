...
\abstract{
The survival analysis using the Cancer Genome Atlas (TCGA) dataset is a well-known method to discover gene expression-based prognostic biomarkers of head and neck squamous cell carcinoma (HNSCC). It is necessary to determine a cutoff point by patients' dichotomization for the continuous gene expression. There is some optimization software for cutoff determination. However, that software's predetermined cutoffs have been set at the median or quantiles of RNA sequencing value to perform the survival analysis. 
...
Using this workflow on the TCGA HNSCC cohort, we scanned human protein-coding genes and adjusted them with confounders and Bonferroni corrected P-value.
...
\subsection{holistic}
TCGA 都是手術後？TNM available yes
discussion: limitation
the TCGA has not collected holistic features
癌症與身心靈的重要關係：中醫、citation?
