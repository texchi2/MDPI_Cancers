...
Then, these preliminary candidates will have an opportunity to be carefully selected by using Bonferroni correction, their effect size (Cox's HR), and the other independent cohort (GSE65858) to prevent the false discovery.
% no more GSE2837
...
%	Table S1: The GSE2837 query results from PrognoScan,
	Table S1: 10 bad guys, % ? don't keep it
	Table S2: 10 good guys, % 要加入 CALML5
