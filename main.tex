...
the Cancer Genome Atlas (TCGA); Transcriptomic Analysis; Survival Analysis; Optimal Cutoff; Effect Size; CAMK2N1; IL19; FCGBP; Mindfulness Meditation} 
...
Xu and his colleagues\cite{Xu2021a} also used Kaplan–Meier survival curves along with a log-rank test or univariate Cox regression to screen prognostic factors (\textit{P} value \begin{equation}< 0.05 \end{equation}).
...
The tables were generated by latex code with the help from https://www.tablesgenerator.com/latex\_tables# and
...
\externalbibliography{yes}
%\bibliography{your_external_BibTeX_file}
\bibliographystyle{chicago} %model1-num-names
