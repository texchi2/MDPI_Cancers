...
The candidate selection performs dissecting and selection of candidate genes by further Bonferroni adjusted \textit{P} values as well as a hazard ratio of Cox model, based on the results from the survival analyses. The selected genes will be validated by a independent HNSCC cohort (GSE2837).
