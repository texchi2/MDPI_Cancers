...
\subsubsection{TCPA validation}
TCGA pathology Deep learning TCPA
...
%氨基酸或DNA等序列的使用可說是相當普遍，由於序列可視為一種具有隱性結構的語言，因此自然語言處理模型所採用的架構便可運用在理解並生成生物醫學領域的序列。


\subsubsection{Holistic cancer care} % by epigenetic control (placebo), person-central approach, PCA
...
Lipton introduced mind-brain-body system.
...
*** TCPA with deep learning: gene expression on pathological section, or digital tissue microarray, TMA
