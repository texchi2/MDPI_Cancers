...
However, the TCGA did not collect other features in holistic cancer care.
...
%%%% PCA and ECA: the delivery of MBSR
...
As the cancer patient feels intense negative emotions of fear, depression, stress, anxiety, fatigue, sadness, it is not the patient-centred therapist’s task to remove these feelings: The task is simply to stay with the patient’s experiences. 
...
捨末求本 find the source
A holistic healthcare providers will engage his/her patients with eye-to-eye contact and mind-to-mind connection. Their compassion, empathy and sympathy is induced by suffering of their patients from those diseases. They treat patients by using medication, surgery, and "themselves"
The resilience of patients will be also induced by the holistic healthcare. % of healing.
...
諮商員的靈性功力
%治療關係: 
Therapeutic relationship: patient said "I would like to talk about myself more when I visit this doctor who I trusted" % 不自覺就講出，不自主就想要聽從他的建議，不再有抗拒
...
%5.心無恐懼: 情志養生
每位醫師都可以成為「創傷知情者」
幫助我們身邊的病患，懂他的心靈創傷，讓他有安全感， 才有機會改變疾病的走向
...
% how placebo effect works? % Environment 改造患者的心，就能改造他的身體環境，有利消除癌症
...
% ***七星山的 idea [2021/03/01]
Generative adversarial networks simulate gene expression and predict perturbations in single cells
3.1. Gene expression in \cite{Ching2018} % deep review
% 環境 -> chromosome accessibility
%  unsupervised deep learning algorithm
generative adversarial networks (GAN) with VAE (variational autoencoder) could simulate environment causing carcinogenesis
%graph convolutional network (from deepchem import GraphConvModel)
deep or graph convolutional network in gene regulation, which includes chromosome accessibility, transcription factor binding site, DNA methylation, and RNA inhibitions (RNAi, microRNA, LncRNA).

%GAN overview
In this paper compares GAN with VAE (variational autoencoder) and RBM (restricted Boltzmann machine) models.
As a new unsupervised learning algorithm framework, generative adversarial networks (GAN) has been favored by more and more researchers, and it has become a research hotspot. GAN is inspired by the two-person zero-sum game theory in game theory. Its unique confrontation training idea can generate high-quality samples and has more powerful feature learning and feature expression ability than traditional machine learning algorithms. At present, GAN has achieved remarkable success in the field of computer vision, especially in the field of sample generation.
%Learning Generative Models of Tissue Organization with Supervised GANs
\cite{Han2018}

%https://www.amazon.com/Deep-Learning-Life-Sciences-Microscopy-ebook/dp/B07QM3G5JM

%book: https://github.com/deepchem/DeepLearningLifeSciences
%https://github.com/deepchem/torchchem
