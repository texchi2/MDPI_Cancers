...
There are eighty-one ($X_1 ... X_81$) physical, pathological and social conditions derived from participants available for survival modeling in the TCGA, 
...
Going for holistic cancer care\cite{Mehta2019}\cite{Iftikhar2021} spiritual and emotional condition is equally essential comparing with physical and social status.
%
...
The patients will trust those who take care of them and have the confidence to increase the capacity to recover from diseases through a mind-brain-body connection manner.
...
Cullen studied the objective science of analytical chemistry. He also sensed that the patient's subjective, psychosomatic, or "sympathetic constitution" determined his reaction to a prescribed therapeutic substance.
...
Cullen's theory of sympathy is a mind-body function, a kind of "vital force" that animated the human body, joint function, and transmitted sensation to target organs\cite{Forget2003}\cite{Kerr2008}.
...
The physician's role was to be a gentle, sympathetic listener who could interpret the patient's sympathetic disorder and select the proper remedy to treat it, either by prescribing placebos to please (influence the patients' emotional states) medicine to cure the patient's disorder.
...
%療癒 
Some studies showed the genetic readout of some inflammatory genes in a group of people who went through a meditation process. After 8 hours of meditation, the activity of the genes changed. 
...
It affects epigenetic regulation.
...
The mind-brain-body axis shows that subconscious fear causes releasing of inflammatory and stress hormones from the brain in terms of cell alteration in DNA methylation, mutation, mRNA expression. Carcinogenesis will occur if the reprogramming is persistent for a longer time.
...
Adverse psychosocial exposures in early life, namely experiences such as child maltreatment, caregiver stress, and community violence, have been associated in epidemiological studies with an increased lifetime risk of adverse outcomes, including diabetes, heart disease, cancers, and psychiatric illnesses. Additional work has shed light on the potential molecular mechanisms by which early adversity becomes "biologically embedded" in altered physiology across body systems.\cite{Berens2017}
%%%%%
...
%# 懺悔
We continually educate our cancer patients that they should repentantly confess for not taking care of body and spirit in the past, and sincere thanks for our physical body does hard work. Mindfulness and meditation will be helpful in cancer healthcare.
...
{
[Carcinogenesis] Under the mind-brain-body axis, a stressful environment will trigger the emotional reception. The subconscious mind (brain) will release stress hormones and inflammation signals in response to the emotion. The inner environment of physical body (cells) alter epigenetic control in terms of gene regulation and mRNA expression. In a long time of incubation, the tissue/cells will be transformed into dysplasia then malignancy.\\
[Cancer care] Holistic care should take care of spiritual, emotional, physical and socioeconomic needs of cancer patients. Physical care will be carried out by medication therapy or surgery. After establishment of therapeutic relationship, the physicians' spiritual properties (empathy, sympathy, and compassion) will engage their patients and recovery their self-compassion to gain the resilience against the disease.
[Suggested health care record] Beside physical, pathological, or psychological data, electric healthcare record (EHR) and \acrshort{tcga} should collect "holistic features".
}
\label{fig:figure5}
\end{figure}
